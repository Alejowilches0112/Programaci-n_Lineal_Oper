function pl = fsimplex(restriccion,f_obj,val,tipo)
comp=eye(size (restriccion,1));

%matriz identidad
case tipo
    of 'maximizar'
        ec = [restriccion(:,:) comp(:,:) val(:); f_obj .* (-1) 0 0 0 0]; %llena la tabla con todas las filas y columnas de las restriccione y todas las filas y columnas de la matriz identidad y los valores totales
    of 'minimizar'
